(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.Geocomplete = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
/*!
...
},{"react/lib/shallowCompare":6}],6:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"fbjs/lib/shallowEqual":2}],7:[function(require,module,exports){
'use strict';
...
/**
 * Entry point for the Geocomplete component
 */

var Geocomplete = function (_React$Component) {
  _inherits(Geocomplete, _React$Component);

  /**
   * The constructor. Sets the initial state.
   * @param  {Object} props The properties object.
   */
  function Geocomplete(props) {
    _classCallCheck(this, Geocomplete);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Geocomplete).call(this, props));
  ...
  _createClass(Geocomplete, [{
     ...
     * @param {GeocompleteItem} suggest The selected suggest item
     */
    ...
    value: function render() {
      var attributes = (0, _filterInputAttributes2.default)(this.props),
          classes = (0, _classnames2.default)('geocomplete', this.props.className),
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'geocomplete__input-wrapper' },
          input
        ),
        _react2.default.createElement(
          'div',
          { className: 'geocomplete__suggests-wrapper' },
          suggestionsList
        )
      );
    }
...
Geocomplete.propTypes = _propTypes2.default;

/**
 * Default values for the properties
 * @type {Object}
 */
Geocomplete.defaultProps = _defaults2.default;

exports.default = Geocomplete;

},{"./defaults":10,"./filter-input-attributes":11,"./input":12,"./prop-types":13,"./suggest-list":15,"classnames":1,"lodash.debounce":3}],8:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.ValidatedGeocomplete = undefined;

var _BaseGeocomplete = require('./BaseGeocomplete');

var _BaseGeocomplete2 = _interopRequireDefault(_BaseGeocomplete);

var _ValidatedGeocomplete = require('./ValidatedGeocomplete');

var _ValidatedGeocomplete2 = _interopRequireDefault(_ValidatedGeocomplete);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.ValidatedGeocomplete = _ValidatedGeocomplete2.default;
exports.default = _BaseGeocomplete2.default;

},{"./BaseGeocomplete":7,"./ValidatedGeocomplete":9}],9:[function(require,module,exports){
'use strict';
...
var ValidatedGeocomplete = function (_React$Component) {
  _inherits(ValidatedGeocomplete, _React$Component);

  function ValidatedGeocomplete(props) {
    _classCallCheck(this, ValidatedGeocomplete);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ValidatedGeocomplete).call(this, props));
    ...
    _this.inputMatchesAutocomplete = _this.inputMatchesAutocomplete.bind(_this);
  ...
  _createClass(ValidatedGeocomplete, [{
    key: 'componentWillMount',
    value: function componentWillMount() {
      var googleMaps = this.props.googleMaps || window.google && // eslint-disable-line no-extra-parens
      window.google.maps || this.googleMaps;
      ...
      if (Boolean(this.props.initialValue)) {
        this.validate(this.props.initialValue, function () {});
      }
    }
  }, {
    key: 'inputMatchesAutocomplete',
    value: function inputMatchesAutocomplete(userInput, matches, doesNotMatch) {
      var _this2 = this;
      ...
      this.autocompleteService.getPlacePredictions(options, function (suggestsGoogle) {
        if ((0, _lodash2.default)(suggestsGoogle, { description: userInput })) {
          matches();
        } else {
    ...
    value: function isValid() {
      ...
      var isValidState = this.state.validationState === "valid",
        ...
        _this3.validate(_this3.value, function () {});
        return false;
      };
    ...
    key: 'validate',
    value: function validate(userInput, afterValidate) {
      var _this5 = this;
      ...
      if (!Boolean(userInput) && shouldValidateRequired) {
        ...
        var inputIsValid = function inputIsValid() {
          _this5.setState({ validationState: 'valid' }, afterValidate);
            ...
            inputIsNotValid = function inputIsNotValid(invalidInput) {
          _this5.setState({ validationState: 'invalidNotFound', notFoundCity: invalidInput }, afterValidate);
        };
    ...
    value: function renderValidationErrors() {
      ...
      switch (this.state.validationState) {
        ...
        case "invalidNotFound":
          ...
          return _react2.default.createElement(ErrorComponent, { userInput: this.state.notFoundCity });
        default:
          return null;
      }
    }
...
ValidatedGeocomplete.propTypes = _propTypes2.default;

/**
 * Default values for the properties
 * @type {Object}
 */
ValidatedGeocomplete.defaultProps = _defaults2.default;

exports.default = ValidatedGeocomplete;

},{"./BaseGeocomplete":7,"./defaults":10,"./prop-types":13,"lodash.some":4}],10:[function(require,module,exports){
'use strict';
...
},{"./filter-input-attributes":11,"classnames":1,"react-addons-shallow-compare":5}],13:[function(require,module,exports){
'use strict';
...
},{"classnames":1,"react-addons-shallow-compare":5}],15:[function(require,module,exports){
'use strict';
...
},{"./suggest-item":14,"classnames":1,"react-addons-shallow-compare":5}]},{},[8])(8)
});